...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (event) => {
        ...
        if (!validateForm()) {
            ...
            // Se pueden enviar los datos del formulario o hacer otras cosas
        }
    });
    ...
    const validateField = (fieldId, errorMessage) => {
        ...
        // Obtiene el valor del campo y elimina los espacios en blanco
        ...
        if (value === '') {
            ...
            return true; 
            // Devuelve true indicando que la validación fue éxitosa
        }
    };
